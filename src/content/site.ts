...
export const labels: Record<Locale, Record<Route | 'home', string>> = {
  'zh-Hant': { home:'首頁', about:'關於實驗室', research:'研究領域', projects:'計畫合作', members:'成員', publications:'出版品', facilities:'實驗設施', news:'最新消息', 'join-us':'加入我們', contact:'聯絡資訊' },
  en: { home:'Home', about:'About', research:'Research', projects:'Projects', members:'Members', publications:'Publications', facilities:'Facilities', news:'News', 'join-us':'Join Us', contact:'Contact' },
};
